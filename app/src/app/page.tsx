                  ...
                  <div className="flex flex-col md:flex-row md:items-center gap-6">
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex flex-wrap gap-3">
                        ...
                        <Link href="https://github.com/tiker-ai/tiker" className="text-neutral-600 dark:text-neutral-400 text-sm font-medium hover:underline flex items-center gap-1">
